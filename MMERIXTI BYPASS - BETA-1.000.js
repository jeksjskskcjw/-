...
// @description    получить ключ за 8 секунд разве тежело?
...
// ==/UserScript==
   ...
   const cfg = new MonkeyConfig({title: 'Bypass Version 1.0 Settings :', menuCommand: true,
